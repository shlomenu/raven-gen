...
class Root(AoTNode):
    ...
    def sample_new(self, component_idx, attr_name, min_level, max_level, root):
        ...
        """
        assert self.is_pg
        self.children[0]._sample_new(component_idx, attr_name, min_level,
                                     max_level, root.children[0])
...
class Structure(AoTNode):
    ...
    def _sample_new(self, component_idx, attr_name, min_level, max_level,
                    structure):
        self.children[component_idx]._sample_new(
            attr_name, min_level, max_level, structure.children[component_idx])
...
class Component(AoTNode):
    ...
    def _sample_new(self, attr_name, min_level, max_level, component):
        self.children[0]._sample_new(attr_name, min_level, max_level,
...
class Entity(AoTNode):
    ...
    def __init__(self, name, bbox, entity_constraint):
        ...
        self.entity_constraint = entity_constraint
        self.bbox = bbox
        self.type = Type(min_level=entity_constraint["Type"][0],
                         max_level=entity_constraint["Type"][1])
        self.type.sample()
        self.size = Size(min_level=entity_constraint["Size"][0],
                         max_level=entity_constraint["Size"][1])
        self.size.sample()
        self.color = Color(min_level=entity_constraint["Color"][0],
                           max_level=entity_constraint["Color"][1])
        self.color.sample()
        self.angle = Angle(min_level=entity_constraint["Angle"][0],

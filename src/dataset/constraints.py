...
def gen_layout_constraint(pos_type,
                          pos_list,
                          num_min=NUM_MIN,
                          num_max=NUM_MAX,
                          uni_min=UNI_MIN,
...
def gen_entity_constraint(type_min=TYPE_MIN,
                          type_max=TYPE_MAX,
                          size_min=SIZE_MIN,
                          size_max=SIZE_MAX,
                          color_min=COLOR_MIN,
...
def rule_constraint(rule_list, num_min, num_max, uni_min, uni_max, type_min,
                    type_max, size_min, size_max, color_min, color_max):
